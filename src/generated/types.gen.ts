...
export type ProcOfficeProjectHeaderDatesNonPublished = Omit<ProcOfficeProjectHeaderDatesInterface, 'status'> & {
    editorialDeadline?: string;
    publicationDate?: string;
 ...
 */
export type ProcOfficeProjectHeaderDatesPublishedAdditionalDefault = Omit<ProcOfficeProjectHeaderDatesPublishedAdditionalInterface, 'processType'> & PublicProjectHeaderDatesBase & {
    /**
     * QNA round dates.
...
export type ProcOfficeProjectHeaderDatesPublishedAdditionalSelectiveNotOfferingPhase = ProcOfficeProjectHeaderDatesPublishedAdditionalSelectiveInterface & PublicProjectHeaderDatesBase & {
    /**
     * QNA round dates.
 ...
 */
export type ProcOfficeProjectHeaderDatesPublishedAdditionalInterface = Omit<ProcOfficeProjectHeaderDatesPublishedInterface, 'pubType' | 'status'> & {
    processType: PubProcessType;
    pubType: PubType;
    status: PubDraftStatus;
};
 ...
 */
export type ProcOfficeProjectHeaderDatesPublishedAdditionalSelectiveInterface = Omit<ProcOfficeProjectHeaderDatesPublishedAdditionalInterface, 'processType'> & {
    processType: PubProcessType;
    pubType?: PubType;
    status?: PubDraftStatus;
};
...
export type ProcOfficeProjectHeaderDatesPublishedInterface = Omit<ProcOfficeProjectHeaderDatesInterface, 'status'> & {
    pubType: PubType;
    status: PubDraftStatus;
};

export type ProcOfficeProjectHeaderDatesPublishedDefault = Omit<ProcOfficeProjectHeaderDatesPublishedInterface, 'pubType' | 'status'> & PublicProjectHeaderDatesBase & {
...
export type PublicationAwardDetail = Omit<PublicationAwardDetailInterface, 'type'> & DetailWithOptionalPubReference & {
    procurement: PublicationAwardProcurement;
    type: 'award';
};

export type PublicationAwardDetailInterface = Omit<PublicationDetailInterface, 'type'> & PublicationDetailWithLotReference & {
    'project-info': PublicationAwardProjectInfo;
    decision: PublicationAwardDecision;
    type: PubType;
};

export type PublicationDirectAwardTenderProcurementService = PublicationDirectAwardTenderProcurementInterface & PublicationBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType: PubProjectType;
};
 ...
 *
 */
export type PublicationDirectAwardTenderProcurementInterface = Omit<PublicationDirectAwardProcurementInterface, 'projectType'> & {
    projectType: 'tender';
};
...
export type PublicationDirectAwardTenderProcurementConstruction = PublicationDirectAwardTenderProcurementInterface & PublicationBaseCodes & {
    oagCodes: Array<OagCode>;
    cpcCode?: CpcCode;
...
export type PublicationDirectAwardGeneralProcurement = Omit<PublicationDirectAwardProcurementInterface, 'projectType'> & PublicationBaseCodes & {
...
export type PublicationDirectAwardDetail = Omit<PublicationAwardDetailInterface, 'type'> & {
...
export type PublicationTenderProjectInfoOpen = Omit<PublicationTenderProjectInfoInterface, 'processType'> & PublicationBaseProjectInfoOpen & {
...
export type PublicationTenderProjectInfoSelective = Omit<PublicationTenderProjectInfoInterface, 'processType'> & PublicationBaseProjectInfoSelective & {
    publicationTed: boolean;
    processType: 'selective';
};

export type PublicationTenderProjectInfoInvitation = Omit<PublicationTenderProjectInfoInterface, 'processType'> & {
...
export type PublicationTenderConstructionLot = Omit<PublicationTenderLotInterface, 'orderType'> & PublicationBaseCodes & PubTenderConstructionFields & {
    orderType: 'construction';
};
...
export type PublicationTenderSupplyLot = Omit<PublicationTenderLotInterface, 'orderType'> & {
    additionalCpvCodes: Array<CpvCode>;
    supplyType: PubSupplyType;
    orderType: 'supply';
};

export type PublicationTenderServiceLot = Omit<PublicationTenderLotInterface, 'orderType'> & PublicationBaseCodes & {
    orderType: 'service';
};
...
export type PublicationTenderProcurementConstruction = Omit<PublicationTenderProcurementInterface, 'orderType'> & PublicationBaseCodes & PubTenderConstructionFields & {
    cpcCode?: CpcCode;
    orderType: 'construction';
};
...
export type PublicationTenderProcurementSupply = Omit<PublicationTenderProcurementInterface, 'orderType'> & {
    additionalCpvCodes?: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
};

export type PublicationTenderProcurementService = Omit<PublicationTenderProcurementInterface, 'orderType'> & PublicationBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
};
...
export type PublicationTenderTermsOpen = Omit<PublicationTenderTermsInterface, 'processType'> & PubBaseTermsOpenSelective & PubBaseTermsWalkthrough & {
    processType: 'open';
};
...
export type PublicationTenderTermsSelective = Omit<PublicationTenderTermsInterface, 'processType'> & PubBaseTermsOpenSelective & PubBaseTermsWalkthrough & {
    processType: 'selective';
};

export type PublicationTenderTermsInvitation = Omit<PublicationTenderTermsInterface, 'processType'> & PubBaseTermsWalkthrough & {
    processType: 'invitation';
};
...
export type PublicationTenderDatesOpen = Omit<PublicationTenderDatesInterface, 'processType'> & PubBaseCallForBidsDates & PublicationBaseDatesOpen & PubTenderDatesOpen & {
    processType: 'open';
};
...
export type PublicationTenderDatesSelective = Omit<PublicationTenderDatesInterface, 'processType'> & PubBaseCallForBidsDates & PublicationBaseDatesSelective & {
    processType: 'selective';
};
...
export type PublicationTenderDatesInvitation = Omit<PublicationTenderDatesInterface, 'processType'> & PubTenderDates & PublicationBaseDatesInvitation & {
    processType: 'invitation';
};
...
export type PublicationTenderCriteriaOpen = Omit<PublicationTenderCriteriaInterface, 'processType'> & {
    processType: 'open';
};
...
export type PublicationTenderCriteriaSelective = Omit<PublicationTenderCriteriaInterface, 'processType'> & PublicationBaseCriteriaSelective & {
    processType: 'selective';
};

export type PublicationTenderCriteriaInvitation = Omit<PublicationTenderCriteriaInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PublicationTenderDetail = Omit<PublicationDetailInterface, 'type'> & PublicationDetailBaseDescription & PublicationDetailWithCorrection & DetailWithOptionalPubReference & DetailWithInvitedVendors & {
...
export type PublicationProjectInfoOpen = Omit<PublicationProjectInfoInterface, 'processType'> & PublicationBaseProjectInfoOpen & {
    processType: 'open';
};
...
export type PublicationProjectInfoSelective = Omit<PublicationProjectInfoInterface, 'processType'> & PublicationBaseProjectInfoSelective & {
    processType: 'selective';
};

export type PublicationProjectInfoInvitation = Omit<PublicationProjectInfoInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PublicationTermsExtendedOpen = Omit<PublicationTermsExtendedInterface, 'processType'> & PubBaseTermsOpenSelective & {
    processType: 'open';
};
...
export type PublicationTermsExtendedSelective = Omit<PublicationTermsExtendedInterface, 'processType'> & PubBaseTermsOpenSelective & {
    processType: 'selective';
};

export type PublicationTermsExtendedInvitation = Omit<PublicationTermsExtendedInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PublicationDatesOpen = Omit<PublicationDatesInterface, 'processType'> & PubBaseCallForBidsDates & PublicationBaseDatesOpen & {
    processType: 'open';
};
...
export type PublicationDatesSelective = Omit<PublicationDatesInterface, 'processType'> & PubBaseCallForBidsDates & PublicationBaseDatesSelective & {
    processType: 'selective';
};

export type PublicationDatesInvitation = Omit<PublicationDatesInterface, 'processType'> & PublicationBaseDatesInvitation & {
    processType: 'invitation';
};
...
export type PublicationCriteriaOpen = Omit<PublicationCriteriaInterface, 'processType'> & {
    processType: 'open';
};
...
export type PublicationCriteriaSelective = Omit<PublicationCriteriaInterface, 'processType'> & PublicationBaseCriteriaSelective & {
    processType: 'selective';
};

export type PublicationCriteriaInvitation = Omit<PublicationCriteriaInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PublicationCompetitionDetail = Omit<PublicationDetailInterface, 'type'> & PublicationDetailBaseDescription & PublicationDetailWithCorrection & DetailWithOptionalPubReference & DetailWithInvitedVendors & {
...
export type PublicationStudyContractDetail = Omit<PublicationDetailInterface, 'type'> & PublicationDetailBaseDescription & PublicationDetailWithCorrection & DetailWithOptionalPubReference & DetailWithInvitedVendors & {
    'project-info': PublicationProjectInfo;
...
export type PublicationParticipantSelectionDetail = Omit<PublicationDetailInterface, 'type'> & PublicationDetailWithLotReference & DetailWithPubReference & {
...
export type PublicationSelectiveOfferingPhaseDetail = Omit<PublicationDetailInterface, 'type'> & PublicationDetailWithLotReference & PublicationDetailWithCorrection & {
    'project-info'?: PubBaseProjectInfoAddress;
...
export type PublicationRevocationDetail = Omit<PublicationDetailInterface, 'type'> & DetailWithPubReference & PubRevocationDetail & {
...
export type PublicationAbandonmentDetail = Omit<PublicationDetailInterface, 'type'> & {
...
export type PublicationRfiDetail = Omit<PublicationDetailInterface, 'type'> & PublicationDetailWithCorrection & DetailWithOptionalPubReference & {
...
export type PublicationAwardBase = PublicationAwardBaseInterface & PubAwardBase & {
    type?: 'award';
};

export type PublicationAwardBaseInterface = Omit<PublicationBaseInterface, 'type'> & PubAwardBaseInterface & {
    type: PubType;
};
...
export type PublicationDirectAwardBase = PublicationAwardBaseInterface & PubDirectAwardBase & AllSubKinds & {
    type?: 'direct_award';
};
...
export type PublicationTenderBase = Omit<PublicationBaseInterface, 'type'> & PublicationLotLimitationData & PublicationCorrectionBase & ReferencingPub & PublicationCpvCode & {
    orderType: PubOrderType;
...
export type PublicationCompetitionBase = Omit<PublicationBaseInterface, 'type'> & PublicationLotLimitationData & PublicationCorrectionBase & ReferencingPub & PublicationCpvCode & {
    competitionType: PubCompetitionType;
    lots: Array<PublicationLotDescription>;
    type: 'competition';
};

export type PublicationStudyContractBase = Omit<PublicationBaseInterface, 'type'> & PublicationLotLimitationData & PublicationCorrectionBase & PublicationCpvCode & ReferencingPub & {
    studyType: PubStudyType;
    lots: Array<PublicationLotDescription>;
    type: 'study_contract';
};
...
export type PublicationRfiBase = Omit<PublicationBaseInterface, 'type'> & PublicationCorrectionBase & PublicationCpvCode & PublicationCpcCode & {
    type: 'request_for_information';
};
...
export type PublicationAbandonmentBase = Omit<PublicationBaseInterface, 'type'> & ReferencingPub & ReferencingLot & {
    publicationTed: boolean;
    type: 'abandonment';
};

export type PublicationRevocationBase = Omit<PublicationBaseInterface, 'type'> & ReferencingPub & {
    publicationTed: boolean;
    type: 'revocation';
};

export type PublicationParticipantSelectionBase = Omit<PublicationBaseInterface, 'type'> & ReferencingPub & ReferencingLot & {
    type: 'participant_selection';
};

export type PublicationSelectiveOfferingPhaseBase = Omit<PublicationBaseInterface, 'type'> & PublicationCorrectionBase & ReferencingPub & ReferencingLot & {
    type: 'selective_offering_phase';
};
...
export type PublicationAwardTenderProcurementService = PublicationAwardTenderProcurementInterface & PublicationBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType: PubProjectType;
};
...
export type PublicationAwardTenderProcurementConstruction = PublicationAwardTenderProcurementInterface & PublicationBaseCodes & {
    oagCodes: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PublicationAwardGeneralProcurement = PublicationAwardProcurementInterface & PublicationBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType: 'competition' | 'study_contract';
...
export type PublicProjectHeaderDatesAdditionalDefault = Omit<PublicProjectHeaderDatesAdditionalInterface, 'processType' | 'pubType'> & PublicProjectHeaderDatesBase & {
    /**
     * QNA round dates.
     * Only available if vendor of logged in user is eligible to see qna rounds or the user belongs to a procurement_office.
     *
 ...
 *
 */
export type PublicProjectHeaderDatesAdditionalSelectiveNotOfferingPhase = PublicProjectHeaderDatesAdditionalSelectiveInterface & PublicProjectHeaderDatesBase & {
    /**
     * QNA round dates.
     * Only available if vendor of logged in user showed interest in the project or the user belongs to a procurement_office.
     *
 ...
 */
export type PublicProjectHeaderDatesAdditionalInterface = Omit<PublicProjectHeaderDatesInterface, 'pubType'> & {
    processType: PubProcessType;
    pubType: PubType;
};
 ...
 */
export type PublicProjectHeaderDatesAdditionalSelectiveInterface = Omit<PublicProjectHeaderDatesAdditionalInterface, 'processType' | 'pubType'> & {
    processType: PubProcessType;
    pubType: PubType;
};
...
export type PublicProjectHeaderDatesDefault = Omit<PublicProjectHeaderDatesInterface, 'pubType'> & PublicProjectHeaderDatesBase & {
    pubType: 'abandonment' | 'direct_award' | 'award' | 'revocation' | 'participant_selection';
};
 ...
 *
 */
export type PubDraftAwardBaseInterface = PubDraftBaseInterface & PubAwardBaseInterface & AllSubKinds & {
    /**
...
export type PubDraftDirectAwardBase = PubDraftAwardBaseInterface & PubDirectAwardBase & {
    type?: 'direct_award';
};

export type PubDraftAwardBase = PubDraftAwardBaseInterface & PubAwardBase & {
    type?: 'award';
};

export type PubDraftTenderBase = PubDraftCallForBidsBaseInterface & PubDraftLotLimitationData & ReferencingPub & {
    orderType: PubOrderType;
 ...
 *
 */
export type PubDraftCallForBidsBaseInterface = PubDraftBaseInterface & PubDraftCorrectionBase & {
    type?: PubType;
};
...
export type PubDraftCompetitionBase = PubDraftCallForBidsBaseInterface & PubDraftLotLimitationData & ReferencingPub & {
    competitionType: PubCompetitionType;
    lots?: Array<PubDraftLotDescription>;
    cpvCode?: CpvCode;
    type?: 'competition';
...
export type PubDraftStudyContractBase = PubDraftCallForBidsBaseInterface & PubDraftLotLimitationData & ReferencingPub & {
    studyType: PubStudyType;
    lots?: Array<PubDraftLotDescription>;
    cpvCode?: CpvCode;
    type?: 'study_contract';
...
export type PubDraftRfiBase = PubDraftBaseInterface & PubDraftCorrectionBase & PubDraftCpcCode & PubDraftCpvCode & {
    type?: 'request_for_information';
};

export type PubDraftAbandonmentBase = PubDraftBaseInterface & AllSubKinds & ReferencingPub & ReferencingLot & {
    publicationTed?: boolean;
    type?: 'abandonment';
};

export type PubDraftRevocationBase = PubDraftBaseInterface & AllSubKinds & ReferencingPub & {
    publicationTed: boolean;
    /**
...
export type PubDraftParticipantSelectionBase = PubDraftBaseInterface & AllSubKinds & ReferencingPub & ReferencingLot & {
    type?: 'participant_selection';
};

export type PubDraftSelectiveOfferingPhaseBase = PubDraftBaseInterface & PubDraftCorrectionBase & AllSubKinds & ReferencingPub & ReferencingLot & {
    /**
...
export type PubDraftAwardDetail = Omit<PubDraftAwardDetailInterface, 'type'> & DetailWithOptionalPubReference & {
    procurement: PubDraftAwardProcurement;
    type: 'award';
};

export type PubDraftAwardDetailInterface = Omit<PubDraftDetailInterface, 'type'> & PubDraftDetailWithLotReference & {
...
export type PubDraftDirectAwardTenderProcurementService = PubDraftDirectAwardTenderProcurementInterface & PubDraftBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType?: PubProjectType;
};
 ...
 *
 */
export type PubDraftDirectAwardTenderProcurementInterface = Omit<PubDraftDirectAwardProcurementInterface, 'projectType'> & {
    projectType: PubProjectType;
};

export type PubDraftBaseCodes = PubBaseCodes;

export type PubDraftDirectAwardTenderProcurementConstruction = PubDraftDirectAwardTenderProcurementInterface & PubDraftBaseCodes & {
    oagCodes?: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PubDraftDirectAwardGeneralProcurement = Omit<PubDraftDirectAwardProcurementInterface, 'projectType'> & PubDraftBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes?: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType: 'competition' | 'study_contract';
...
export type PubDraftDirectAwardDetail = Omit<PubDraftAwardDetailInterface, 'type'> & {
...
export type PubDraftTenderProjectInfoOpen = Omit<PubDraftTenderProjectInfoInterface, 'processType'> & PubBaseProjectInfoOpen & {
    publicationTed?: boolean;
    processType: 'open';
};
...
export type PubDraftTenderProjectInfoSelective = Omit<PubDraftTenderProjectInfoInterface, 'processType'> & PubBaseProjectInfoSelective & {
    publicationTed?: boolean;
    processType: 'selective';
};

export type PubDraftTenderProjectInfoInvitation = Omit<PubDraftTenderProjectInfoInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PubDraftTenderConstructionLot = Omit<PubDraftTenderLotInterface, 'orderType'> & PubDraftBaseCodes & PubTenderConstructionFields & {
    orderType: 'construction';
};
...
export type PubDraftTenderSupplyLot = Omit<PubDraftTenderLotInterface, 'orderType'> & {
    additionalCpvCodes?: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
};

export type PubDraftTenderServiceLot = Omit<PubDraftTenderLotInterface, 'orderType'> & PubDraftBaseCodes & {
    orderType: 'service';
};
...
export type PubDraftTenderProcurementConstruction = Omit<PubDraftTenderProcurementInterface, 'orderType'> & PubDraftBaseCodes & PubTenderConstructionFields & {
    cpcCode?: CpcCode;
    orderType: 'construction';
};
...
export type PubDraftTenderProcurementSupply = Omit<PubDraftTenderProcurementInterface, 'orderType'> & {
    additionalCpvCodes?: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
};

export type PubDraftTenderProcurementService = Omit<PubDraftTenderProcurementInterface, 'orderType'> & PubDraftBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
};
...
export type PubDraftTenderTermsOpen = Omit<PubDraftTenderTermsInterface, 'processType'> & PubBaseTermsOpenSelective & PubBaseTermsWalkthrough & {
    processType: 'open';
};
...
export type PubDraftTenderTermsSelective = Omit<PubDraftTenderTermsInterface, 'processType'> & PubBaseTermsOpenSelective & PubBaseTermsWalkthrough & {
    processType: 'selective';
};

export type PubDraftTenderTermsInvitation = Omit<PubDraftTenderTermsInterface, 'processType'> & PubBaseTermsWalkthrough & {
    processType: 'invitation';
};
...
export type PubDraftTenderDatesOpen = Omit<PubDraftTenderDatesInterface, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesOpen & PubTenderDatesOpen & {
    processType: 'open';
};
...
export type PubDraftTenderDatesSelective = Omit<PubDraftTenderDatesInterface, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesSelective & {
    processType: 'selective';
};

export type PubDraftTenderDatesInvitation = Omit<PubDraftTenderDatesInterface, 'processType'> & PubTenderDates & PubBaseDatesInvitation & {
    processType: 'invitation';
};
...
export type PubDraftTenderCriteriaOpen = Omit<PubDraftTenderCriteriaInterface, 'processType'> & {
    processType: 'open';
};
...
export type PubDraftTenderCriteriaSelective = Omit<PubDraftTenderCriteriaInterface, 'processType'> & PubDraftBaseCriteriaSelective & {
    processType: 'selective';
};

export type PubDraftTenderCriteriaInvitation = Omit<PubDraftTenderCriteriaInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PubDraftTenderDetail = Omit<PubDraftDetailInterface, 'type'> & PubDraftDetailBaseDescription & PubDraftDetailWithCorrection & DetailWithOptionalPubReference & DetailWithInvitedVendors & {
...
export type PubDraftProjectInfoOpen = Omit<PubDraftProjectInfoInterface, 'processType'> & PubBaseProjectInfoOpen & {
    processType: 'open';
};
...
export type PubDraftProjectInfoSelective = Omit<PubDraftProjectInfoInterface, 'processType'> & PubBaseProjectInfoSelective & {
    processType: 'selective';
};

export type PubDraftProjectInfoInvitation = Omit<PubDraftProjectInfoInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PubDraftTermsExtendedOpen = Omit<PubDraftTermsExtendedInterface, 'processType'> & PubBaseTermsOpenSelective & {
    processType: 'open';
};
...
export type PubDraftTermsExtendedSelective = Omit<PubDraftTermsExtendedInterface, 'processType'> & PubBaseTermsOpenSelective & {
    processType: 'selective';
};

export type PubDraftTermsExtendedInvitation = Omit<PubDraftTermsExtendedInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PubDraftDatesOpen = Omit<PubDraftDatesInterface, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesOpen & {
    processType: 'open';
};
...
export type PubDraftDatesSelective = Omit<PubDraftDatesInterface, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesSelective & {
    processType: 'selective';
};

export type PubDraftDatesInvitation = Omit<PubDraftDatesInterface, 'processType'> & PubBaseDatesInvitation & {
    processType: 'invitation';
};
...
export type PubDraftCriteriaOpen = Omit<PubDraftCriteriaInterface, 'processType'> & {
    processType: 'open';
};
...
export type PubDraftCriteriaSelective = Omit<PubDraftCriteriaInterface, 'processType'> & PubDraftBaseCriteriaSelective & {
    processType: 'selective';
};

export type PubDraftCriteriaInvitation = Omit<PubDraftCriteriaInterface, 'processType'> & {
    processType: 'invitation';
};
...
export type PubDraftCompetitionDetail = Omit<PubDraftDetailInterface, 'type'> & PubDraftDetailBaseDescription & PubDraftDetailWithCorrection & DetailWithOptionalPubReference & DetailWithInvitedVendors & {
...
export type PubDraftStudyContractDetail = Omit<PubDraftDetailInterface, 'type'> & PubDraftDetailBaseDescription & PubDraftDetailWithCorrection & DetailWithOptionalPubReference & DetailWithInvitedVendors & {
    'project-info': PubDraftProjectInfo;
...
export type PubDraftParticipantSelectionDetail = Omit<PubDraftDetailInterface, 'type'> & PubDraftDetailWithLotReference & DetailWithPubReference & {
    'project-info': PubBaseProjectInfoAddress;
    procurement: PubDraftDirectAwardProcurement;
...
export type PubDraftSelectiveOfferingPhaseDetail = Omit<PubDraftDetailInterface, 'type'> & PubDraftDetailWithLotReference & PubDraftDetailWithCorrection & {
    'project-info': PubBaseProjectInfoAddress;
...
export type PubDraftRevocationDetail = Omit<PubDraftDetailInterface, 'type'> & DetailWithPubReference & PubRevocationDetail & {
...
export type PubDraftAbandonmentDetail = Omit<PubDraftDetailInterface, 'type'> & {
...
export type PubDraftRfiDetail = Omit<PubDraftDetailInterface, 'type'> & DetailWithOptionalPubReference & PubDraftDetailWithCorrection & {
...
export type PubDraftAwardTenderProcurementService = PubDraftAwardTenderProcurementInterface & PubDraftBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType?: PubProjectType;
};
...
export type PubDraftAwardTenderProcurementConstruction = PubDraftAwardTenderProcurementInterface & PubDraftBaseCodes & {
    oagCodes?: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PubDraftAwardGeneralProcurement = PubDraftAwardProcurementInterface & PubDraftBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes?: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType?: 'competition' | 'study_contract';
...
export type ContentComponentInfoBox = Omit<ContentComponent, 'componentType'> & {
    content: TranslationSanitizedHtml;
    componentType: 'info_box';
};

export type ContentComponentTextSection = Omit<ContentComponent, 'componentType'> & {
    title?: Translation;
    content: TranslationSanitizedHtml;
...
export type ContentComponentLinks = Omit<ContentComponent, 'componentType'> & {
    title?: Translation;
...
export type ContentComponentVideos = Omit<ContentComponent, 'componentType'> & {
...
export type ContentComponentArticles = Omit<ContentComponent, 'componentType'> & {
...
export type MainActivitiesWritable = {
    mainActivities: Array<MainActivityWritable>;
};
 ...
 *
 */
export type SustainabilityFormMappingsWritable = {
    [key: string]: Array<SustainabilityFormType>;
};

export type BaseProcOfficeWritable = ProcOfficePublicData & {
    language?: SystemLanguage;
 ...
 *
 */
export type ProcOfficeWritable = BaseProcOfficeWritable & {
    organizationInContractContact?: Contact;
    address: Address;
};

export type ProcOfficeHistoryBaseDataEntryWritable = BaseHistory & BaseProcOfficeWritable & {
    deleted?: boolean;
};

export type ProcOfficeHistoryBaseDataEntriesWritable = {
    procOfficeHistoryBaseDataEntries: Array<ProcOfficeHistoryBaseDataEntryWritable>;
    pagination: RollingPagination;
};

export type PublicationAwardDetailWritable = Omit<PublicationAwardDetailInterfaceWritable2, 'type'> & DetailWithOptionalPubReferenceWritable & {
    procurement: PublicationAwardProcurementWritable;
    type: 'award';
};

export type PublicationAwardDetailInterfaceWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailWithLotReference & {
    'project-info': PublicationAwardProjectInfo;
    decision: PublicationAwardDecisionWritable;
    type: PubType;
};

export type PublicationDirectAwardTenderProcurementServiceWritable = PublicationDirectAwardTenderProcurementInterfaceWritable2 & PublicationBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType: PubProjectType;
};
 ...
 *
 */
export type PublicationDirectAwardTenderProcurementInterfaceWritable = Omit<PublicationDirectAwardProcurementInterfaceWritable2, 'projectType'> & {
    projectType: 'tender';
};

export type PublicationDirectAwardTenderProcurementConstructionWritable = PublicationDirectAwardTenderProcurementInterfaceWritable2 & PublicationBaseCodes & {
    oagCodes: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PublicationDirectAwardTenderProcurementSupplyWritable = PublicationDirectAwardTenderProcurementInterfaceWritable2 & {
    additionalCpvCodes: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
    projectType: PubProjectType;
...
export type PublicationDirectAwardProcurementInterfaceWritable = PubDirectAwardProcurement & {
    externalReference?: PubAndLotReferenceWritable;
};

export type PublicationDirectAwardGeneralProcurementWritable = Omit<PublicationDirectAwardProcurementInterfaceWritable2, 'projectType'> & PublicationBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType: 'competition' | 'study_contract';
...
export type PubReferenceWritable = {
    /**
     * Reference to publicationId. Null in case of a reference to an external publication.
     */
    publicationId?: string;
...
export type PubAndLotReferenceWritable = PubReferenceWritable & LotReference & {
    lotsType: PubLotsType;
};
 ...
 * PublicationDirectAwardTenderProcurement
 */
export type PublicationDirectAwardTenderProcurementWritable = ({
    orderType: 'service';
} & PublicationDirectAwardTenderProcurementServiceWritable) | ({
    orderType: 'construction';
} & PublicationDirectAwardTenderProcurementConstructionWritable) | ({
    orderType: 'supply';
} & PublicationDirectAwardTenderProcurementSupplyWritable);

/**
 * PublicationDirectAwardProcurement
 */
export type PublicationDirectAwardProcurementWritable = ({
    projectType: 'tender';
} & PublicationDirectAwardTenderProcurementWritable) | ({
    projectType: 'competition' | 'study_contract';
} & PublicationDirectAwardGeneralProcurementWritable) | ({
    projectType: 'competition' | 'study_contract';
} & PublicationDirectAwardGeneralProcurementWritable);

export type PublicationDirectAwardDetailWritable = Omit<PublicationAwardDetailInterfaceWritable2, 'type'> & {
    procurement: PublicationDirectAwardProcurementWritable;
    type: 'direct_award';
};
...
export type DetailWithOptionalPubReferenceWritable = {
    referencingPub?: PubReferenceWritable;
};
...
export type PubInvitedVendorWritable = PubVendorWithAddressDataWritable;

export type PubInvitedVendorsPatchWritable = {
    /**
     * true if invited vendors should get published together with the call_for_bids publication.
     * This means the invited vendors would be visible to the other invited vendors but not publicly visible,
     * as the publication itself is only visible to the invited vendors and the proc_office itself.
     ...
     */
    publishInvitedVendors?: boolean;
    vendors?: Array<PubInvitedVendorWritable>;
};

export type PubInvitedVendorsWritable = PubInvitedVendorsPatchWritable;

/**
 * InvitedVendors are only available for call_for_bids in invitation process.
 *
 */
export type DetailWithInvitedVendorsWritable = {
    invitedVendors?: PubInvitedVendorsWritable;
};

export type PublicationTenderDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailBaseDescription & PublicationDetailWithCorrection & DetailWithOptionalPubReferenceWritable & DetailWithInvitedVendorsWritable & {
    'project-info': PublicationTenderProjectInfo;
    lots?: Array<PublicationTenderLot>;
    procurement: PublicationTenderProcurement;
    terms: PublicationTenderTerms;
...
export type PublicationCompetitionDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailBaseDescription & PublicationDetailWithCorrection & DetailWithOptionalPubReferenceWritable & DetailWithInvitedVendorsWritable & {
    'project-info': PublicationProjectInfo;
    lots?: Array<PublicationCompetitionLot>;
    procurement: PublicationProcurement;
    terms: PublicationTermsExtended;
...
export type PublicationStudyContractDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailBaseDescription & PublicationDetailWithCorrection & DetailWithOptionalPubReferenceWritable & DetailWithInvitedVendorsWritable & {
    'project-info': PublicationProjectInfo;
    lots?: Array<PublicationStudyContractLot>;
    procurement: PublicationProcurement;
    terms: PublicationTermsExtended;
...
export type DetailWithPubReferenceWritable = DetailWithOptionalPubReferenceWritable;

export type PublicationAwardedVendorBaseWritable = {
    vendorId: string;
};

export type PublicationParticipantSelectionQualifiedVendorWritable = PublicationAwardedVendorBaseWritable;

export type PublicationParticipantSelectionInfoWritable = {
    participantSelectionLimitation: ThreeValuedSelection;
    participantSelectionNote?: Translation;
    participantSelectionCommunication: ParticipantSelectionCommunication;
    remediesNotice?: Translation;
     ...
     *
     */
    vendors: Array<PublicationParticipantSelectionQualifiedVendorWritable>;
};

export type PublicationParticipantSelectionDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailWithLotReference & DetailWithPubReferenceWritable & {
    'project-info': PubBaseProjectInfoAddress;
    procurement: PublicationDirectAwardProcurementWritable;
    'participant-selection': PublicationParticipantSelectionInfoWritable;
    type: 'participant_selection';
};

export type PublicationSelectiveOfferingPhaseDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailWithLotReference & PublicationDetailWithCorrection & {
    'project-info'?: PubBaseProjectInfoAddress;
    notice: PublicationSelectiveOfferingPhaseNotice;
    dates: PublicationSelectiveOfferingPhaseDates;
    criteria: PublicationSelectiveOfferingPhaseCriteria;
...
export type PublicationRevocationDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & DetailWithPubReferenceWritable & PubRevocationDetail & {
    revocation: PublicationRevocationInfo;
    'project-info': PubBaseProjectInfoAddress;
    type: 'revocation';
};

export type PublicationAbandonmentDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & {
    abandonment: PublicationAbandonmentInfo;
    /**
     * The lot which was abandoned or null in case the whole project was abandoned which is always the case if
     * the project was created without lots
...
export type PublicationAdvanceNoticeDetailDiscriminatorWritable = ({
    projectType: 'competition';
} & PublicationCompetitionDetailWritable) | ({
    projectType: 'study_contract';
} & PublicationStudyContractDetailWritable) | ({
    projectType: 'tender';
} & PublicationTenderDetailWritable);

export type PublicationRfiDetailWritable = Omit<PublicationDetailInterfaceWritable2, 'type'> & PublicationDetailWithCorrection & DetailWithOptionalPubReferenceWritable & {
    'project-info': PublicationRfiProjectInfo;
    dates: PublicationRfiDates;
    procurement: PublicationRfiProcurement;
    terms: PublicationRfiTerms;
...
export type PublicationAwardVendorSubmissionWritable = PublicationAwardedVendorBaseWritable & {
    price?: PriceWithVat;
    note?: Translation;
    rank?: number;
};

export type PublicationAwardDecisionWritable = PubAwardDecision & {
    remediesNotice?: Translation;
    /**
     * List of vendors which have been awarded for this publication
     *
     */
    vendors: Array<PublicationAwardVendorSubmissionWritable>;
};

export type PublicationAwardTenderProcurementServiceWritable = PublicationAwardTenderProcurementInterfaceWritable2 & PublicationBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType: PubProjectType;
};
 ...
 *
 */
export type PublicationAwardTenderProcurementInterfaceWritable = PublicationAwardProcurementInterfaceWritable2 & {
    projectType: 'tender';
};

export type PublicationAwardTenderProcurementConstructionWritable = PublicationAwardTenderProcurementInterfaceWritable2 & PublicationBaseCodes & {
    oagCodes: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PublicationAwardTenderProcurementSupplyWritable = PublicationAwardTenderProcurementInterfaceWritable2 & {
    additionalCpvCodes: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
    projectType: PubProjectType;
...
export type PublicationAwardProcurementInterfaceWritable = PubAwardProcurement & {
    externalReference?: PubAndLotReferenceWritable;
};

export type PublicationAwardGeneralProcurementWritable = PublicationAwardProcurementInterfaceWritable2 & PublicationBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType: 'competition' | 'study_contract';
 ...
 * PublicationAwardTenderProcurement
 */
export type PublicationAwardTenderProcurementWritable = ({
    orderType: 'service';
} & PublicationAwardTenderProcurementServiceWritable) | ({
    orderType: 'construction';
} & PublicationAwardTenderProcurementConstructionWritable) | ({
    orderType: 'supply';
} & PublicationAwardTenderProcurementSupplyWritable);

/**
 * PublicationAwardProcurement
 */
export type PublicationAwardProcurementWritable = ({
    projectType: 'tender';
} & PublicationAwardTenderProcurementWritable) | ({
    projectType: 'competition' | 'study_contract';
} & PublicationAwardGeneralProcurementWritable) | ({
    projectType: 'competition' | 'study_contract';
} & PublicationAwardGeneralProcurementWritable);

export type PublicationDetailWritable = ({
    type: 'tender';
} & PublicationTenderDetailWritable) | ({
    type: 'competition';
} & PublicationCompetitionDetailWritable) | ({
    ...
    type: 'award';
} & PublicationAwardDetailWritable) | ({
    type: 'direct_award';
} & PublicationDirectAwardDetailWritable) | ({
    type: 'participant_selection';
} & PublicationParticipantSelectionDetailWritable) | ({
    type: 'selective_offering_phase';
} & PublicationSelectiveOfferingPhaseDetailWritable) | ({
    type: 'revocation';
} & PublicationRevocationDetailWritable) | ({
    type: 'abandonment';
} & PublicationAbandonmentDetailWritable) | ({
    type: 'advance_notice';
} & PublicationAdvanceNoticeDetailDiscriminatorWritable) | ({
    type: 'request_for_information';
} & PublicationRfiDetailWritable);

export type PublicProjectActionsWritable = {
    [key: string]: unknown;
};

export type PublicProjectHeaderWritable = BaseProjectData & {
    /**
     * Lots information of this project. Only provided if project was created with lotsType 'with'
     */
    lots?: Array<PublicProjectHeaderLot>;
    ...
    latestVendorDigitalSubmission?: PublicProjectHeaderVendorDigitalSubmissionInfo;
    vendorStatus?: ProjectInvitedOrInterestedVendorStatus;
    actions: PublicProjectActionsWritable;
};
 ...
 *
 */
export type PubDraftAwardBaseInterfaceWritable = PubDraftBaseInterfaceWritable & PubAwardBaseInterface & AllSubKinds & {
    type?: PubType;
};

export type PubDraftDirectAwardBaseWritable = PubDraftAwardBaseInterfaceWritable2 & PubDirectAwardBase & {
    type?: 'direct_award';
};

export type PubDraftAwardBaseWritable = PubDraftAwardBaseInterfaceWritable2 & PubAwardBase & {
    type?: 'award';
};

export type PubDraftBaseWritable = ({
    type: 'award';
} & PubDraftAwardBaseWritable) | ({
    type: 'tender';
} & PubDraftTenderBase) | ({
    type: 'competition';
} & PubDraftCompetitionBase) | ({
    ...
    type: 'direct_award';
} & PubDraftDirectAwardBaseWritable) | ({
    type: 'advance_notice';
} & PubDraftAdvanceNoticeDiscriminator) | ({
    type: 'request_for_information';
} & PubDraftRfiBase) | ({
...
export type PubDraftAwardDetailWritable = Omit<PubDraftAwardDetailInterfaceWritable2, 'type'> & DetailWithOptionalPubReferenceWritable & {
    procurement: PubDraftAwardProcurementWritable;
    type: 'award';
};

export type PubDraftAwardDetailInterfaceWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & PubDraftDetailWithLotReference & {
    'project-info': PubDraftAwardProjectInfo;
    decision: PubDraftAwardDecisionDetailWritable;
    statistics: PubDraftAwardStatisticsWritable;
    type: PubType;
};

export type PubDraftDirectAwardTenderProcurementServiceWritable = PubDraftDirectAwardTenderProcurementInterfaceWritable2 & PubDraftBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType?: PubProjectType;
};
 ...
 *
 */
export type PubDraftDirectAwardTenderProcurementInterfaceWritable = Omit<PubDraftDirectAwardProcurementInterfaceWritable2, 'projectType'> & {
    projectType: PubProjectType;
};

export type PubDraftDirectAwardTenderProcurementConstructionWritable = PubDraftDirectAwardTenderProcurementInterfaceWritable2 & PubDraftBaseCodes & {
    oagCodes?: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PubDraftDirectAwardTenderProcurementSupplyWritable = PubDraftDirectAwardTenderProcurementInterfaceWritable2 & {
    additionalCpvCodes?: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
    projectType?: PubProjectType;
 ...
 *
 */
export type PubDraftDirectAwardTenderProcurementWritable = ({
    orderType: 'service';
} & PubDraftDirectAwardTenderProcurementServiceWritable) | ({
    orderType: 'construction';
} & PubDraftDirectAwardTenderProcurementConstructionWritable) | ({
    orderType: 'supply';
} & PubDraftDirectAwardTenderProcurementSupplyWritable);

export type PubDraftDirectAwardProcurementInterfaceWritable = PubDirectAwardProcurement & {
    externalReference?: PubAndLotReferenceWritable;
};

export type PubDraftDirectAwardGeneralProcurementWritable = Omit<PubDraftDirectAwardProcurementInterfaceWritable2, 'projectType'> & PubDraftBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes?: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType: 'competition' | 'study_contract';
 ...
 *
 */
export type PubDraftDirectAwardProcurementWritable = ({
    projectType: 'competition' | 'study_contract';
} & PubDraftDirectAwardGeneralProcurementWritable) | ({
    projectType: 'tender';
} & PubDraftDirectAwardTenderProcurementWritable);

export type PubDraftDirectAwardDetailWritable = Omit<PubDraftAwardDetailInterfaceWritable2, 'type'> & {
    procurement: PubDraftDirectAwardProcurementWritable;
    type: 'direct_award';
};
 ...
 * Interface / parent that is implemented by the  PubDraft*Detail models, used for code generation.
 */
export type PubDraftDetailInterfaceWritable = {
    id: string;
    type: PubType;
    projectType: PubProjectType;
    base?: PubDraftBaseWritable;
    ted?: PubTedReference;
    /**
     * List of publishers of this publication
     */
...
export type PubDraftTenderConstructionLotWritable = Omit<PubDraftTenderLotInterfaceWritable2, 'orderType'> & PubDraftBaseCodes & PubTenderConstructionFields & {
    orderType: 'construction';
};
 ...
 *
 */
export type PubDraftTenderLotInterfaceWritable = PubDraftBaseLotWritable & PubTenderSpecificProcurementFields;

export type PubDraftTenderSupplyLotWritable = Omit<PubDraftTenderLotInterfaceWritable2, 'orderType'> & {
    additionalCpvCodes?: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
};

export type PubDraftTenderServiceLotWritable = Omit<PubDraftTenderLotInterfaceWritable2, 'orderType'> & PubDraftBaseCodes & {
    orderType: 'service';
};
 ...
 *
 */
export type PubDraftTenderLotWritable = ({
    orderType: 'construction';
} & PubDraftTenderConstructionLotWritable) | ({
    orderType: 'supply';
} & PubDraftTenderSupplyLotWritable) | ({
    orderType: 'service';
} & PubDraftTenderServiceLotWritable);

export type PubDraftTenderTermsOpenWritable = Omit<PubDraftTenderTermsInterfaceWritable2, 'processType'> & PubBaseTermsOpenSelective & PubBaseTermsWalkthrough & {
    processType: 'open';
};
 ...
 *
 */
export type PubDraftTenderTermsInterfaceWritable = PubDraftBaseTermsWritable & {
    processType: PubProcessType;
    orderType: PubOrderType;
};

export type PubDraftTenderTermsSelectiveWritable = Omit<PubDraftTenderTermsInterfaceWritable2, 'processType'> & PubBaseTermsOpenSelective & PubBaseTermsWalkthrough & {
    processType: 'selective';
};

export type PubDraftTenderTermsInvitationWritable = Omit<PubDraftTenderTermsInterfaceWritable2, 'processType'> & PubBaseTermsWalkthrough & {
    processType: 'invitation';
};

export type PubDraftTermsRemediesChangedWritable = PubDraftTermsRemedies;

export type PubDraftBaseTermsWritable = PubDraftTermsRemediesChangedWritable & PubBaseTerms;
 ...
 *
 */
export type PubDraftTenderTermsWritable = ({
    processType: 'open';
} & PubDraftTenderTermsOpenWritable) | ({
    processType: 'selective';
} & PubDraftTenderTermsSelectiveWritable) | ({
    processType: 'invitation';
} & PubDraftTenderTermsInvitationWritable);

export type PubDraftTenderDatesOpenWritable = Omit<PubDraftTenderDatesInterfaceWritable2, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesOpen & PubTenderDatesOpen & {
    processType: 'open';
};
 ...
 *
 */
export type PubDraftTenderDatesInterfaceWritable = PubDraftBaseDatesAppointmentsWritable & {
    processType: PubProcessType;
    orderType: PubOrderType;
};

export type PubDraftTenderDatesSelectiveWritable = Omit<PubDraftTenderDatesInterfaceWritable2, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesSelective & {
    processType: 'selective';
};

export type PubDraftTenderDatesInvitationWritable = Omit<PubDraftTenderDatesInterfaceWritable2, 'processType'> & PubTenderDates & PubBaseDatesInvitation & {
    processType: 'invitation';
};
...
export type PubDraftBaseDatesAppointmentsWritable = {
    qnas: Array<PubDraftQnaWritable>;
    otherAppointments: Array<PubDraftAppointment>;
};
 ...
 *
 */
export type PubDraftTenderDatesWritable = ({
    processType: 'open';
} & PubDraftTenderDatesOpenWritable) | ({
    processType: 'selective';
} & PubDraftTenderDatesSelectiveWritable) | ({
    processType: 'invitation';
} & PubDraftTenderDatesInvitationWritable);

export type PubDraftTenderDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & PubDraftDetailBaseDescription & PubDraftDetailWithCorrection & DetailWithOptionalPubReferenceWritable & DetailWithInvitedVendorsWritable & {
    'project-info': PubDraftTenderProjectInfo;
    lots?: Array<PubDraftTenderLotWritable>;
    procurement: PubDraftTenderProcurement;
    terms: PubDraftTenderTermsWritable;
    dates: PubDraftTenderDatesWritable;
    criteria?: PubDraftTenderCriteria;
    type: 'tender';
};

export type PubDraftCompetitionLotWritable = PubDraftBaseLotWritable & PubDraftBaseCodes & {
    processType: PubProcessType;
    procurementTopic: PubProcurementTopic;
    oagCodes?: Array<OagCode>;
    constructionCategory: PubConstructionCategoryOptional;
...
export type PubDraftTermsExtendedOpenWritable = Omit<PubDraftTermsExtendedInterfaceWritable2, 'processType'> & PubBaseTermsOpenSelective & {
    processType: 'open';
};
 ...
 *
 */
export type PubDraftTermsExtendedInterfaceWritable = PubDraftBaseTermsWritable & PubBaseTermsExtended & {
    processType: PubProcessType;
};

export type PubDraftTermsExtendedSelectiveWritable = Omit<PubDraftTermsExtendedInterfaceWritable2, 'processType'> & PubBaseTermsOpenSelective & {
    processType: 'selective';
};

export type PubDraftTermsExtendedInvitationWritable = Omit<PubDraftTermsExtendedInterfaceWritable2, 'processType'> & {
    processType: 'invitation';
};
 ...
 *
 */
export type PubDraftTermsExtendedWritable = ({
    processType: 'open';
} & PubDraftTermsExtendedOpenWritable) | ({
    processType: 'selective';
} & PubDraftTermsExtendedSelectiveWritable) | ({
    processType: 'invitation';
} & PubDraftTermsExtendedInvitationWritable);

export type PubDraftDatesOpenWritable = Omit<PubDraftDatesInterfaceWritable2, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesOpen & {
    processType: 'open';
};
 ...
 *
 */
export type PubDraftDatesInterfaceWritable = PubDraftBaseDatesAppointmentsWritable & {
    processType: PubProcessType;
};

export type PubDraftDatesSelectiveWritable = Omit<PubDraftDatesInterfaceWritable2, 'processType'> & PubBaseCallForBidsDates & PubBaseDatesSelective & {
    processType: 'selective';
};

export type PubDraftDatesInvitationWritable = Omit<PubDraftDatesInterfaceWritable2, 'processType'> & PubBaseDatesInvitation & {
    processType: 'invitation';
};
 ...
 *
 */
export type PubDraftDatesWritable = ({
    processType: 'open';
} & PubDraftDatesOpenWritable) | ({
    processType: 'selective';
} & PubDraftDatesSelectiveWritable) | ({
    processType: 'invitation';
} & PubDraftDatesInvitationWritable);

export type PubDraftCompetitionDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & PubDraftDetailBaseDescription & PubDraftDetailWithCorrection & DetailWithOptionalPubReferenceWritable & DetailWithInvitedVendorsWritable & {
    'project-info': PubDraftProjectInfo;
    lots?: Array<PubDraftCompetitionLotWritable>;
    procurement: PubDraftProcurement;
    terms: PubDraftTermsExtendedWritable;
    dates: PubDraftDatesWritable;
    criteria?: PubDraftCriteria;
    type: 'competition';
};

export type PubDraftStudyContractLotWritable = PubDraftBaseLotWritable & PubDraftBaseCodes & {
    processType: PubProcessType;
    procurementTopic: PubProcurementTopic;
    oagCodes?: Array<OagCode>;
    constructionCategory: PubConstructionCategoryOptional;
...
export type PubDraftStudyContractDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & PubDraftDetailBaseDescription & PubDraftDetailWithCorrection & DetailWithOptionalPubReferenceWritable & DetailWithInvitedVendorsWritable & {
    'project-info': PubDraftProjectInfo;
    lots?: Array<PubDraftStudyContractLotWritable>;
    procurement: PubDraftProcurement;
    terms: PubDraftTermsExtendedWritable;
    dates: PubDraftDatesWritable;
    criteria?: PubDraftCriteria;
...
export type PubDraftParticipantSelectionQualifiedVendorWritable = PubDraftAwardedVendorWritable & {
    /**
     * True if vendor was qualified for the second phase of the selective process
     *
     */
...
export type PubDraftParticipantSelectionInfoWritable = PubDraftTermsRemediesChangedWritable & {
    participantSelectionLimitation: ThreeValuedSelection;
    participantSelectionNote?: Translation;
    participantSelectionCommunication: ParticipantSelectionCommunication;
    /**
     ...
     *
     */
    vendors: Array<PubDraftParticipantSelectionQualifiedVendorWritable>;
    publicationDate?: string;
};

export type PubDraftParticipantSelectionDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & PubDraftDetailWithLotReference & DetailWithPubReferenceWritable & {
    'project-info': PubBaseProjectInfoAddress;
    procurement: PubDraftDirectAwardProcurementWritable;
    'participant-selection': PubDraftParticipantSelectionInfoWritable;
    type: 'participant_selection';
};

export type PubDraftSelectiveOfferingPhaseDatesWritable = PubDraftBaseDatesAppointmentsWritable & PubBaseDates & PubBaseDatesOpen;

export type PubDraftSelectiveOfferingPhaseDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & PubDraftDetailWithLotReference & PubDraftDetailWithCorrection & {
    'project-info': PubBaseProjectInfoAddress;
    notice: PubDraftSelectiveOfferingPhaseNotice;
    dates: PubDraftSelectiveOfferingPhaseDatesWritable;
    criteria: PubDraftSelectiveOfferingPhaseCriteria;
    type: 'selective_offering_phase';
};
 ...
 *
 */
export type PubDraftRevocationInfoWritable = PubDraftTermsRemediesChangedWritable & {
    publicationDate?: string;
    reason?: Translation;
    remarks?: Translation;
};

export type PubDraftRevocationDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & DetailWithPubReferenceWritable & PubRevocationDetail & {
    revocation: PubDraftRevocationInfoWritable;
    'project-info': PubBaseProjectInfoAddress;
    procurement?: PubProcurementOrderDescription;
    /**
     * Lot specific procurement and lot information of the revoked publication. Only provided in case of projects
...
export type PubDraftAbandonmentInfoWritable = PubDraftTermsRemediesChangedWritable & PubAbandonmentInfo;

export type PubDraftAbandonmentDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & {
    abandonment: PubDraftAbandonmentInfoWritable;
    /**
     * The lot which was abandoned or null in case the whole project was abandoned which is always the case if
     * the project was created without lots
     *
...
export type PubDraftAdvanceNoticeDetailDiscriminatorWritable = ({
    projectType: 'competition';
} & PubDraftCompetitionDetailWritable) | ({
    projectType: 'study_contract';
} & PubDraftStudyContractDetailWritable) | ({
    projectType: 'tender';
} & PubDraftTenderDetailWritable);

/**
 * Model for the rfi dates
 */
export type PubDraftRfiDatesWritable = PubBaseCallForBidsDates & PubDraftBaseDatesAppointmentsWritable;

export type PubDraftRfiDetailWritable = Omit<PubDraftDetailInterfaceWritable2, 'type'> & DetailWithOptionalPubReferenceWritable & PubDraftDetailWithCorrection & {
    'project-info': PubDraftRfiProjectInfo;
    dates: PubDraftRfiDatesWritable;
    procurement: PubDraftRfiProcurement;
    terms: PubDraftRfiTerms;
    type: 'request_for_information';
};

export type PubDraftStatisticsAwardedVendorWritable = PubVendorWithAddressDataWritable & {
    price?: PriceWithVat;
};

export type PubDraftAwardVendorSubmissionWritable = PubDraftStatisticsAwardedVendorWritable & {
    note?: Translation;
    rank?: number;
    /**
     * True if vendor was awarded for this publication.
...
export type PubDraftAwardDecisionDetailWritable = PubDraftAwardDecisionExport & {
    vendors: Array<PubDraftAwardVendorSubmissionWritable>;
};

export type PubDraftAwardStatisticsWritable = {
    totalPrice?: PriceWithVat;
    justificationDirectAward?: JustificationDirectAward;
    vendors: Array<PubDraftStatisticsAwardedVendorWritable>;
};

export type PubDraftAwardTenderProcurementServiceWritable = PubDraftAwardTenderProcurementInterfaceWritable2 & PubDraftBaseCodes & {
    cpcCode?: CpcCode;
    orderType: 'service';
    projectType?: PubProjectType;
};
 ...
 *
 */
export type PubDraftAwardTenderProcurementInterfaceWritable = PubDraftAwardProcurementInterfaceWritable2 & {
    projectType?: PubProjectType;
};

export type PubDraftAwardTenderProcurementConstructionWritable = PubDraftAwardTenderProcurementInterfaceWritable2 & PubDraftBaseCodes & {
    oagCodes?: Array<OagCode>;
    cpcCode?: CpcCode;
    constructionType?: PubConstructionType;
    constructionCategory?: PubConstructionCategoryOptional;
...
export type PubDraftAwardTenderProcurementSupplyWritable = PubDraftAwardTenderProcurementInterfaceWritable2 & {
    additionalCpvCodes?: Array<CpvCode>;
    supplyType?: PubSupplyType;
    orderType: 'supply';
    projectType?: PubProjectType;
 ...
 *
 */
export type PubDraftAwardTenderProcurementWritable = ({
    orderType: 'service';
} & PubDraftAwardTenderProcurementServiceWritable) | ({
    orderType: 'construction';
} & PubDraftAwardTenderProcurementConstructionWritable) | ({
    orderType: 'supply';
} & PubDraftAwardTenderProcurementSupplyWritable);

export type PubDraftAwardProcurementInterfaceWritable = PubAwardProcurement & {
    externalReference?: PubAndLotReferenceWritable;
};

export type PubDraftAwardGeneralProcurementWritable = PubDraftAwardProcurementInterfaceWritable2 & PubDraftBaseCodes & {
    procurementTopic?: PubProcurementTopic;
    oagCodes?: Array<OagCode>;
    constructionCategory?: PubConstructionCategoryOptional;
    projectType?: 'competition' | 'study_contract';
 ...
 *
 */
export type PubDraftAwardProcurementWritable = ({
    projectType: 'competition' | 'study_contract';
} & PubDraftAwardGeneralProcurementWritable) | ({
    projectType: 'tender';
} & PubDraftAwardTenderProcurementWritable);

/**
 * Full detail of a publication draft
 */
export type PubDraftDetailWritable = ({
    type: 'tender';
} & PubDraftTenderDetailWritable) | ({
    type: 'competition';
} & PubDraftCompetitionDetailWritable) | ({
    ...
    type: 'award';
} & PubDraftAwardDetailWritable) | ({
    type: 'direct_award';
} & PubDraftDirectAwardDetailWritable) | ({
    type: 'participant_selection';
} & PubDraftParticipantSelectionDetailWritable) | ({
    type: 'selective_offering_phase';
} & PubDraftSelectiveOfferingPhaseDetailWritable) | ({
    type: 'revocation';
} & PubDraftRevocationDetailWritable) | ({
    type: 'abandonment';
} & PubDraftAbandonmentDetailWritable) | ({
    type: 'advance_notice';
} & PubDraftAdvanceNoticeDetailDiscriminatorWritable) | ({
    type: 'request_for_information';
} & PubDraftRfiDetailWritable);

export type PubDraftAwardDecisionStepWritable = PubDraftAwardDecisionDetailWritable & PubDraftTermsRemediesChangedWritable & {
    publicationDate?: string;
};
...
export type PubDraftAwardSustainabilityFormWritable = {
    contactFirstName?: string;
    contactLastName?: string;
    contactFunction?: string;
    contactPhone?: string;
...
export type ContentComponentArticlesWritable = Omit<ContentComponentWritable, 'componentType'> & {
    category: ContentComponentArticleCategory;
    items: Array<ContentComponentMetadataArticleItemWritable>;
    componentType: 'articles';
};
...
export type SustainabilityTriggersWritable = {
    sustainabilityTriggers?: Array<SustainabilityTriggerWritable>;
};

export type PubDraftAwardBaseTypeWritable = ({
    type: 'award';
} & PubDraftAwardBaseWritable) | ({
    type: 'direct_award';
} & PubDraftDirectAwardBaseWritable);
 ...
 *
 */
export type AwardedVendorExportWritable = {
    award: PubDraftAwardBaseTypeWritable;
    lot?: LotReference;
    procurementRecipient: PubAddress;
    procurementOffice: {
        type: ProcOfficeType;
    ...
    decision: PubDraftAwardDecisionExport;
    statistics: PubDraftAwardStatisticsExport;
    awardedVendor: PubDraftAwardVendorSubmissionWritable;
};
 ...
 *
 */
export type SustainabilityFormExportWritable = {
    processType: PubProcessType;
    projectNumber: string;
    lotNumber?: number;
    /**
    ...
    form: PubDraftAwardSustainabilityFormWritable;
};
...
export type PubDraftBaseInterfaceWritable = PubDraftData & {
    status: PubDraftStatus;
    /**
     * The editorial deadline for the selected publication date, the pub draft must be submitted before this date and time.
     */
 ...
 *
 */
export type PubDraftAwardBaseInterfaceWritable2 = PubDraftBaseInterface & PubAwardBaseInterface & AllSubKinds & {
    /**
     * Sustainability forms, the procurement office can choose from in an award publication.
     * Currently supported is either [nh01] or [nh02, nh03, nh04, nh05] or null if no sustainability keyfigures are required.
     *
 ...
 * Interface / parent that is implemented by the  PubDraft*Detail models, used for code generation.
 */
export type PubDraftDetailInterfaceWritable2 = {
    id: string;
    type: PubType;
    projectType: PubProjectType;
    base?: PubDraftBase;
 ...
 *
 */
export type PubDraftTenderLotInterfaceWritable2 = PubDraftBaseLot & PubTenderSpecificProcurementFields;

/**
 * Interface / parent that is implemented by the  PubDraftTenderTerms* models, used for code generation.
 *
 */
export type PubDraftTenderTermsInterfaceWritable2 = PubDraftBaseTerms & {
    processType: PubProcessType;
    orderType: PubOrderType;
};
 ...
 *
 */
export type PubDraftTenderDatesInterfaceWritable2 = PubDraftBaseDatesAppointments & {
    processType: PubProcessType;
    orderType: PubOrderType;
};
 ...
 *
 */
export type PubDraftTermsExtendedInterfaceWritable2 = PubDraftBaseTerms & PubBaseTermsExtended & {
    processType: PubProcessType;
};
 ...
 *
 */
export type PubDraftDatesInterfaceWritable2 = PubDraftBaseDatesAppointments & {
    processType: PubProcessType;
};
 ...
 * Basic properties for a content-component. Extra properties are added depending on the discriminator type
 */
export type ContentComponentWritable = {
    id: string;
    componentType: ComponentType;
    position: number;
};
...
export type PatchPubDraftTenderDatesData = {
    body: PubDraftTenderDatesWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftTenderTermsData = {
    body: PubDraftTenderTermsWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftTenderLotData = {
    body: PubDraftTenderLotWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftTenderInvitedVendorsData = {
    body: PubInvitedVendorsPatchWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftCompetitionTermsData = {
    body: PubDraftTermsExtendedWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftCompetitionLotData = {
    body: PubDraftCompetitionLotWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftStudyContractLotData = {
    body: PubDraftStudyContractLotWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftAwardProcurementData = {
    body: PubDraftDirectAwardProcurementWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftAwardDecisionData = {
    body: PubDraftAwardDecisionStepWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftAwardStatisticsData = {
    body: PubDraftAwardStatisticsWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftAwardSustainabilityFormData = {
    body: PubDraftAwardSustainabilityFormWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftAbandonmentInfoData = {
    body: PubDraftAbandonmentInfoWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftRevocationData = {
    body: PubDraftRevocationInfoWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftParticipantSelectionData = {
    body: PubDraftParticipantSelectionInfoWritable;
    path: {
        /**
         * Id of the publication draft.
         */
...
export type PatchPubDraftSelectiveOfferingPhaseDatesData = {
    body: PubDraftSelectiveOfferingPhaseDatesWritable;
    path: {
        /**
         * Id of the publication draft.
         */
